...
write.csv(merged_mspI_BS, "/vols/GPArkaitz_bigdata/ulazcano/AC80_RRBS/06_Annotation/mspI_BS_geneAnnotation20250512.csv")

##############
# mspItaqaI_BS
##############
mspItaqaI_BS_CpGs <- getData(mspItaqaI_BS_CpGs)
mspItaqaI_BS_CpGs$index <- paste0("chr", mspItaqaI_BS_CpGs$chr, "_", mspItaqaI_BS_CpGs$start)

merged_mspItaqaI_BS <- merge(mspItaqaI_BS_CpGs, cpgs_df_annotated, by = "index", all.x=T)
write.csv(merged_mspItaqaI_BS, "/vols/GPArkaitz_bigdata/ulazcano/AC80_RRBS/06_Annotation/mspItaqaI_BS_geneAnnotation20250512.csv")
...
merged_mspIhaeIII_BS <- merge(mspIhaeIII_BS_CpGs, cpgs_df_annotated, by = "index", all.x=T)
write.csv(merged_mspIhaeIII_BS, "/vols/GPArkaitz_bigdata/ulazcano/AC80_RRBS/06_Annotation/mspIhaeIII_BS_geneAnnotation20250512.csv")
...
merged_mspI_Enzym <- merge(mspI_Enzym_CpGs, cpgs_df_annotated, by = "index", all.x=T)
write.csv(merged_mspI_Enzym, "/vols/GPArkaitz_bigdata/ulazcano/AC80_RRBS/06_Annotation/mspI_Enzym_geneAnnotation20250512.csv")

##############
# mspItaqaI_Enzym
##############
mspItaqaI_Enzym_CpGs <- getData(mspItaqaI_enzym_CpGs)
mspItaqaI_Enzym_CpGs$index <- paste0("chr", mspItaqaI_Enzym_CpGs$chr, "_", mspItaqaI_Enzym_CpGs$start)

merged_mspItaqaI_Enzym <- merge(mspItaqaI_Enzym_CpGs, cpgs_df_annotated, by = "index", all.x=T)
write.csv(merged_mspItaqaI_Enzym, "/vols/GPArkaitz_bigdata/ulazcano/AC80_RRBS/06_Annotation/mspItaqaI_Enzym_geneAnnotation20250512.csv")
...
merged_mspIhaeIII_Enzym <- merge(mspIhaeIII_Enzym_CpGs, cpgs_df_annotated, by = "index", all.x=T)
write.csv(merged_mspIhaeIII_Enzym, "/vols/GPArkaitz_bigdata/ulazcano/AC80_RRBS/06_Annotation/mspIhaeIII_Enzym_geneAnnotation20250512.csv")
