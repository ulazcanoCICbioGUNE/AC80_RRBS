...
dir_infiles <- paste(path_bigdata, project, "/04_Bismark/Unmeth_control/", sep="")

# Create output directory
dir.create(file.path(path_bigdata, project,"/05_Methylation_extraction/Unmeth_control/"))
dir_outfiles <- paste(path_bigdata, project,"/05_Methylation_extraction/Unmeth_control",sep='')
#LUEGO BORRAR
...
#for (i in 1:1) {
  # Job name
  job_name <- paste("Unmeth_",samples_names[i],"_BISMARK_methylation_extractor",sep='');
